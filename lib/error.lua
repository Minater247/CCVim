...
local errStrings = {
    ...
    [13] = "File exists (add ! to override)",
    ...
    [93] = function(params) return "More than one match for " .. tostring(params[1] or "") end,
    [96] = "Cannot diff more than 8 buffers",
    [99] = "Current buffer is not in diff mode",
    [100] = "No other buffer in diff mode",
    [101] = "More than two buffers in diff mode, don't know which one to use",
    [102] = function(params) return "Can't find buffer \"" .. tostring(params[1] or "") .. "\"" end,
    [32] = "No file name",
    [36] = "Not enough room",
    [37] = "No write since last change (add ! to override)",
    [45] = "'readonly' option is set (add ! to override)",
    [48] = "Not allowed in sandbox",
    [54] = "Unmatched \\(",
    [55] = "Unmatched \\)",
    [69] = "Missing ] after \\%[",
    ...
    [338] = "Sorry, no file browser in console mode",
    ...
    [793] = "No other buffer in diff mode is modifiable",
    [794] = "Cannot set variable in the sandbox",
