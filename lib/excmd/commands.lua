...
local COMMAND_SPECS = {
    ...
    { name = "map", min = 3, dispatch = true,
        map = { action = "map", recursive = true, modes = "nvo", bang_modes = "ic", min_abbrev = 3 } },
    ...
    { name = "noremap", min = 2, dispatch = true,
        map = { action = "map", recursive = false, modes = "nvo", bang_modes = "ic", min_abbrev = 2 } },
    ...
    { name = "unmap", min = 3, dispatch = true,
        map = { action = "unmap", modes = "nvo", bang_modes = "ic", min_abbrev = 3 } },
    ...
    { name = "mapclear", min = 4, dispatch = true,
        map = { action = "clear", modes = "nvo", bang_modes = "ic", min_abbrev = 4 } },
