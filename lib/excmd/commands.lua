...
local COMMAND_SPECS = {
    ...
    { name = "nnoremap", min = 2, dispatch = true, map = { action = "map", recursive = false, modes = "n", min_abbrev = 2 } },
    { name = "xnoremap", min = 2, dispatch = true, map = { action = "map", recursive = false, modes = "x", min_abbrev = 2 } },
    { name = "inoremap", min = 3, dispatch = true, map = { action = "map", recursive = false, modes = "i", min_abbrev = 3 } },
    { name = "onoremap", min = 3, dispatch = true, map = { action = "map", recursive = false, modes = "o", min_abbrev = 3 } },
    { name = "xmap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "x", min_abbrev = 2 } },
    { name = "nmap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "n", min_abbrev = 2 } },
    { name = "omap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "o", min_abbrev = 2 } },
    { name = "imap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "i", min_abbrev = 2 } },
    ...
    { name = "smap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "s", min_abbrev = 2 } },
    { name = "lmap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "l", min_abbrev = 2 } },
    { name = "cmap", min = 2, dispatch = true, map = { action = "map", recursive = true, modes = "c", min_abbrev = 2 } },
    { name = "tmap", min = 3, dispatch = true, map = { action = "map", recursive = true, modes = "t", min_abbrev = 3 } },
    { name = "noremap", min = 2, dispatch = true, map = { action = "map", recursive = false, modes = "nvo", bang_modes = "ic", min_abbrev = 2 } },
    { name = "vnoremap", min = 2, dispatch = true, map = { action = "map", recursive = false, modes = "vs", min_abbrev = 2 } },
    { name = "snoremap", min = 4, dispatch = true, map = { action = "map", recursive = false, modes = "s", min_abbrev = 4 } },
    { name = "lnoremap", min = 2, dispatch = true, map = { action = "map", recursive = false, modes = "l", min_abbrev = 2 } },
    { name = "cnoremap", min = 3, dispatch = true, map = { action = "map", recursive = false, modes = "c", min_abbrev = 3 } },
    { name = "tnoremap", min = 3, dispatch = true, map = { action = "map", recursive = false, modes = "t", min_abbrev = 3 } },
    { name = "unmap", min = 3, dispatch = true, map = { action = "unmap", modes = "nvo", bang_modes = "ic", min_abbrev = 3 } },
    ...
    { name = "mapclear", min = 4, dispatch = true, map = { action = "clear", modes = "nvo", bang_modes = "ic", min_abbrev = 4 } },
