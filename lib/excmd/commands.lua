...
local COMMAND_SPECS = {
    { name = "!", min = 1, no_bar_split = true, comment_mode = "expr" },
    { name = "silent", min = 3, dispatch = true, wrapper = true },
    { name = "unsilent", min = 3, dispatch = true, wrapper = true },
    { name = "let", min = 3, comment_mode = "expr", complete = "expression" },
    ...
    { name = "call", min = 3, comment_mode = "expr", complete = "expression" },
    { name = "execute", min = 3, comment_mode = "expr" },
    { name = "unlet", min = 3, complete = "var" },
    { name = "command", min = 3, dispatch = true, no_bar_split = true },
    { name = "autocmd", min = 2, no_bar_split = true, complete = "event" },
    { name = "syntax", min = 3, dispatch = true, no_bar_split = true, complete = "syntax" },
    { name = "sign", min = 3, dispatch = true, no_bar_split = true, complete = "sign" },
    { name = "highlight", min = 2, dispatch = true, complete = "highlight" },
    { name = "colorscheme", min = 4, dispatch = true, complete = "color" },
    { name = "runtime", min = 2, dispatch = true, complete = "runtime" },
    { name = "augroup", min = 3, dispatch = true, complete = "augroup" },
    ...
    { name = "nnoremap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = false, modes = "n", min_abbrev = 2 } },
    { name = "xnoremap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = false, modes = "x", min_abbrev = 2 } },
    { name = "inoremap", min = 3, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = false, modes = "i", min_abbrev = 3 } },
    { name = "onoremap", min = 3, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = false, modes = "o", min_abbrev = 3 } },
    { name = "xmap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = true, modes = "x", min_abbrev = 2 } },
    { name = "nmap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = true, modes = "n", min_abbrev = 2 } },
    { name = "omap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = true, modes = "o", min_abbrev = 2 } },
    { name = "imap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "map", recursive = true, modes = "i", min_abbrev = 2 } },
    { name = "nunmap", min = 3, dispatch = true, complete = "mapping",
        map = { action = "unmap", modes = "n", min_abbrev = 3 } },
    { name = "xunmap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "unmap", modes = "x", min_abbrev = 2 } },
    { name = "ounmap", min = 2, dispatch = true, complete = "mapping",
        map = { action = "unmap", modes = "o", min_abbrev = 2 } },
    { name = "defer", min = 4 },
    { name = "noautocmd", min = 3, wrapper = true },
    { name = "browse", min = 3, wrapper = true },
    { name = "confirm", min = 4, wrapper = true },
    { name = "hide", min = 3, wrapper = true },
    { name = "keepmarks", min = 3, wrapper = true },
    { name = "lockmarks", min = 3, wrapper = true },
    { name = "noswapfile", min = 3, wrapper = true },
    { name = "sandbox", min = 3, wrapper = true },
    { name = "tab", min = 3, wrapper = true },
    ...
    { name = "mapclear", min = 4, dispatch = true, complete = "mapclear",
    ...
    { name = "keeppatterns", min = 5, dispatch = true, wrapper = true },
    ...
    { name = "doautocmd", min = 4, dispatch = true, complete = "event" },
    { name = "delcommand", min = 4, dispatch = true, complete = "command" },
    { name = "delfunction", min = 4, dispatch = true, complete = "function" },
    { name = "comclear", min = 4, dispatch = true },
    { name = "buffer", min = 2, dispatch = true, addr = "count", complete = "buffer" },
    ...
    { name = "tabclose", min = 4, dispatch = true, addr = "count" },
    { name = "drop", min = 2, dispatch = true, complete = "file" },
    { name = "diffsplit", min = 5, dispatch = true, complete = "file" },
    { name = "diffthis", min = 5, dispatch = true, addr = "none" },
    { name = "diffoff", min = 5, dispatch = true, addr = "none" },
    { name = "diffupdate", min = 3, dispatch = true, addr = "none" },
    { name = "diffget", min = 5, dispatch = true, addr = "line", complete = "diff_buffer" },
    { name = "diffput", min = 6, dispatch = true, addr = "line", complete = "diff_buffer" },
    { name = "help", min = 1, dispatch = true, complete = "help" },
    { name = "helptags", min = 5, dispatch = true, complete = "dir" },
    { name = "lcd", min = 2, dispatch = true, complete = "dir" },
    { name = "tcd", min = 2, dispatch = true, complete = "dir" },
    { name = "lua", min = 2, dispatch = true, no_bar_split = true, complete = "lua" },
    { name = "messages", min = 3, dispatch = true, complete = "messages" },
    ...
    { name = "syntime", min = 4, dispatch = true, complete = "syntime" },
...
for _, spec in ipairs(COMMAND_SPECS) do
    if spec.menu and not spec.complete then
        spec.complete = "menu"
    elseif spec.map and not spec.complete then
        spec.complete = spec.map.action == "clear" and "mapclear" or "mapping"
    end
