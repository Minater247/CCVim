...
local COMMAND_SPECS = {
    ...
    { name = "nunmap", min = 3, dispatch = true, complete = "mapping", map = { action = "unmap", modes = "n", min_abbrev = 3 } },
    { name = "xunmap", min = 2, dispatch = true, complete = "mapping", map = { action = "unmap", modes = "x", min_abbrev = 2 } },
    { name = "ounmap", min = 2, dispatch = true, complete = "mapping", map = { action = "unmap", modes = "o", min_abbrev = 2 } },
    { name = "defer", min = 4 },
