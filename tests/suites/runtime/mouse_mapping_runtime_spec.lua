return {
    ...
    description = "Ports mapped mouse events through CCVim's real event loop; lua-editor-only because it targets the internal ComputerCraft mouse bridge.", -- luacheck: ignore 631
