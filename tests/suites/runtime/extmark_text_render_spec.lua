return {
    ...
    description = "Ports extmark virtual text and virtual line rendering through the real Window render path; lua-editor-only because it asserts CCVim terminal grid output.", -- luacheck: ignore 631
