...
local child = { value = 1 }
local list = { child, 2 }
local list_copy = Fn.fn.copy(list)
...
local dict_copy = Fn.fn.copy(dict)
...
assert_eq("copy preserves dict kind", Fn.fn.type(dict_copy), 4)
