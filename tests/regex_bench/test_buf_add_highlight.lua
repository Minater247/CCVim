...
local ext = api.nvim_buf_get_extmarks(buf.bufnr, ns1, 0, -1, { details = true })
assert(#ext == 1, "one extmark in namespace")
assert(ext[1].mark.opts.hl_group == "ErrorMsg")
assert(ext[1].mark.opts.end_col == 2)
